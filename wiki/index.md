...
> **Purpose**: Content-oriented catalog of all wiki pages. The LLM reads this first to find relevant pages when answering queries.
...
| [[concepts/generalized-magnitude-coherence\|Generalized Magnitude Coherence (GMC)]] | Multi-microphone coherence measure via eigenvalue decomposition; inherently integrates N channels | 2026-05-27 |
...
| [[concepts/artificial-residual-noise\|Artificial Residual Noise]] | Non-stationary residual noise generated by DNN speech enhancement; exceeds the speech masking threshold by 10-50 dB, motivating classical SPP-based postfiltering | 2026-09-03 |
...
| [[sources/lollmann-2020-generalized-coherence-based-signal-enhancement\|Löllmann, Brendel & Kellermann 2020: Generalized Coherence-Based Signal Enhancement]] | GMC-based CDR estimator using eigenvalue decomposition; implicit microphone selection; 4-mic binaural HA evaluation | 2020 |
...
| [[synthesis/virtual-sensing-evolution\|Virtual Sensing Evolution]] | Development of remote quiet zones: from fixed RMT training to neural Obs-TasNet filters | LJDPCZ9G, WY4S7C6Z, WX2XSXDA, YHFLXFQH |
...
> Saved answers to specific questions, analyses, and explorations.

| Page | Question/Topic | Date |
|------|---------------|------|
| [[queries/what-is-simplified-adaptive-feedback-anc\|什么是 Simplified Adaptive Feedback ANC]] | 完整的 SimpAFB 系统介绍：核心思想、稳定性、性能对比、实验结果 | 2026-04-10 |
| [[queries/how-to-estimate-secondary-path\|如何估计次级通道]] | 完整文献综述：离线建模、加性噪声在线建模、联立方程法、SPR、进化搜索、Careful Control、元学习；21 篇 Zotero 论文 | 2026-04-10 |
| [[queries/far-field-multichannel-speech-enhancement-algorithms\|Far-Field Multichannel Speech Enhancement]] | 14 章综述：波束形成、MWF、噪声估计、去混响、DOA、BSS、深度学习等，覆盖 50+ 篇 Zotero 文献 | 2026-04-11 |
