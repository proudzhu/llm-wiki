...
**Affiliation**: Key Laboratory of Modern Acoustics, Institute of Acoustics, Nanjing University, Nanjing, China (`nju.edu.cn` address)
**Role**: Researcher
**Research Focus**: Active noise control, deep-learning-based ANC, neural network controllers for headphone ANC.
