...
**Affiliation**: KU Leuven, Leuven, Belgium (ESAT / STADIUS Center for Dynamical Systems, Signal Processing and Data Analytics)
**Role**: Professor / Supervisor
**Research Focus**: Signal processing, adaptive filtering, acoustic feedback control, speech and audio processing, communication systems.
