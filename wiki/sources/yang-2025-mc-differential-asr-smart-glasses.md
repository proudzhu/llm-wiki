...
[[concepts/wearer-speech-recognition|Wearer speech recognition (WSR)]] on smart glasses is vulnerable to side-talk from bystanders, because the microphones operate in open-field conditions rather than close-talk. Prior work ([Lin et al. 2024 — AGADIR](sources/lin-2024-agadir-array-geometry-agnostic-speech-recognition.md), [Feng et al. 2025](sources/feng-2025-directional-source-separation-smart-glasses.md)) used a beamformer as the sole frontend to the ASR model. However, when only the wearer is being transcribed in the presence of side-talk, the beamformer alone cannot fully suppress the WSR degradation. Traditional alternatives — speech enhancement, speaker diarization, [[concepts/target-speaker-extraction|target speaker extraction]] — add latency and may require modeling speaker identity, raising privacy concerns for an always-on wearable.
