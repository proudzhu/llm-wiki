...
All Python scripts are in the `scripts/` subdirectory. Run from the project root using `python .trae/skills/wiki-lint/scripts/<script>.py`.
...
```bash
python .trae/skills/wiki-lint/scripts/count_files.py
```
...
```bash
python .trae/skills/wiki-lint/scripts/count_index_rows.py
```
...
```bash
python .trae/skills/wiki-lint/scripts/check_index_drift.py
```
...
```bash
python .trae/skills/wiki-lint/scripts/check_broken_links.py
```
...
```bash
python .trae/skills/wiki-lint/scripts/check_orphans.py
```
...
```bash
python .trae/skills/wiki-lint/scripts/check_statistics.py
```
...
```bash
python .trae/skills/wiki-lint/scripts/rebuild_index.py
```
...
```bash
python .trae/skills/wiki-lint/scripts/verify_index.py
```
